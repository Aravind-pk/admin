...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE `regstart` SET name=(:name), email=(:email), dob=(:dob), batch=(:batch), addr=(:address) WHERE phone=(:idedit)";
...
?>
	...
	<body>
		<?php
		$sql = "SELECT * from `regstart` where phone = :editid";
		$query = $dbh->prepare($sql);
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data" name="imgform">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="number" name="mobileno" class="form-control" required value="<?php echo htmlentities($result->phone); ?>" disabled>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="address" class="form-control" required value="<?php echo htmlentities($result->addr); ?>">
													</div>
												</div>
