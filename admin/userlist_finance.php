				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-sm-1 col-lg-12 col-md-12">
							...
							<h2 class="page-title">Online payed users</h2>
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
                                                        ...
                                                        <?php if($result->flag == '--')
                                                    {?>
                                                    <a href="userlist_finance.php?confirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Verify')">Verify <i class="fa fa-check-circle"></i></a> 
                                                    <?php } else {?>
                                                    <a href="userlist_finance.php?unconfirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Unverify')"> Unverify <i class="fa fa-times-circle"></i></a>
													<?php } ?>
															<br>
